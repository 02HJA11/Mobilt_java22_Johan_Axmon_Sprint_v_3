    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          //none of these are used since scrolling seems to work most of the time
          //single scroll view/ single child scroll view https://api.flutter.dev/flutter/widgets/SingleChildScrollView-class.html
